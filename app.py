...
if filtered_df.empty:
    ...
    with tab1:
        ...
        with col1:
            ...
            fig = px.line(energy_intensity_trend, x='year', y='energy_intensity',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="MWh per Unit", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            ...
            fig.update_layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig = px.line(carbon_intensity_trend, x='year', y='carbon_intensity',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="tCO₂e per MUSD", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig = px.line(waste_recycled_trend, x='year', y='waste_recycled_pct',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="Waste Recycled (%)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
            ...
            fig.update_layout(yaxis_title="Tonnes per Unit", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig = go.Figure()
            # --- THEME UPDATE ---
            fig.update_layout(template="plotly_dark", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
        ...
        with col1:
            ...
            fig = px.line(water_intensity_trend, x='year', y='water_intensity',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="m³ per Unit", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig = px.scatter(regional_water, x='water_withdrawal_m3', y='water_recycled_pct',
                             ...
                             hover_data=['region'])
            fig.update_layout(xaxis_title="Water Withdrawal (m³)", yaxis_title="Water Recycled (%)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig.update_layout(yaxis_title="Green Efficiency Score", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
            ...
            fig.update_layout(xaxis_title="Carbon Intensity (tCO₂e/MUSD)",
                              yaxis_title="Green Efficiency Score", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig.update_layout(xaxis_title="Carbon Intensity (tCO₂e/MUSD)", yaxis_title="ESG Score", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
    ...
    with tab2:
        ...
        with col1:
            ...
            fig.update_layout(yaxis_title="Percentage", yaxis_tickformat=".0%", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig = px.line(minority_trend, x='year', y='minority_pct', color='region',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="Minority Percentage", yaxis_tickformat=".1%", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
            ...
            fig.update_layout(yaxis_title="Pay Equity Ratio (Female to Male)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig.update_layout(yaxis_title="Training Hours", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
            ...
            fig = px.line(turnover_trend, x='period', y='employee_turnover_pct',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="Turnover Rate", yaxis_tickformat=".1%", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig = px.line(safety_trend, x='year', y='lost_time_incident_rate',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="Incident Rate", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig = px.line(engagement_trend, x='year', y='employee_engagement_score',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="Engagement Score", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
            ...
            fig.update_layout(yaxis_title="Community Investment (USD M)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig.update_layout(xaxis_title="Employee Engagement Score",
                              ...
                              yaxis_tickformat=".1%", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig.update_layout(xaxis_title="Training Hours Level", yaxis_title="Region", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig = px.bar(social_index_dept, x='department', y='social_well_being_index',
                         ...
                         color_continuous_scale='Viridis')
            fig.update_layout(yaxis_title="Social Well-Being Index", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig.update_layout(yaxis_title="Diversity & Inclusion Index", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
    ...
    with tab3:
        ...
        with col2:
            ...
            if 'fines_penalties_usd_m' in filtered_df.columns:
                ...
                fig = px.bar(fines_trend, x='year', y='fines_penalties_usd_m',
                             ...
                             color_continuous_scale='Reds')
                fig.update_layout(yaxis_title="Fines (USD M)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
                st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig = px.bar(gov_by_dept, x='department', y='governance_effectiveness_index',
                         ...
                         color_continuous_scale='Viridis')
            fig.update_layout(yaxis_title="Governance Effectiveness Index", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col1:
            ...
            fig = px.scatter(filtered_df,
                             ...
                             trendline="ols")
            fig.update_layout(xaxis_title="ESG Policy Coverage (%)", yaxis_title="ESG Score", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
            ...
            fig = px.line(supplier_trend, x='year', y='supplier_code_of_conduct_coverage_pct',
                          ...
                          markers=True)
            fig.update_layout(yaxis_title="Supplier Code Coverage (%)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
        ...
        with col2:
            ...
            fig.update_layout(yaxis_title="ESG Policy Coverage (%)", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', title_font_color='#f1f5f9')
            st.plotly_chart(fig, use_container_width=True)
